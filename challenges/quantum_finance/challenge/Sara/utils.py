...
def granularity(k: int = K) -> float:
    """Returns the amount of discretization depending on the number of
    qubits assigned per asset. This is closely related to how much can
    the Hamiltonian formulation be. 
